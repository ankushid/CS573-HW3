...
train_x = tempvar["train_dat_x"]
val_x = tempvar["val_dat_x"]

# Dataset D1
train_y1 = tempvar["train_dat_y"]
val_y1 = tempvar["val_dat_y"]

# Dataset D2
train_y2 = tempvar["train_dat_y2"]
val_y2 = tempvar["val_dat_y2"]
...
def run_bagging(train_x, train_y, val_x, val_y, dataset_key):
    for est in est_list:
...
print("\nDataset D1")
run_bagging(train_x, train_y1, val_x, val_y1, "D1")
run_boosting(train_x, train_y1, val_x, val_y1, "D1")

print("\nDataset D2")
run_bagging(train_x, train_y2, val_x, val_y2, "D2")
run_boosting(train_x, train_y2, val_x, val_y2, "D2")